...
class Func_PlotAPLLinearity(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        self.setWindowTitle("APL Linearity Plot")
        ...
        topleft_canvas.figure = APL_Share.SubFigList["Linearity_data_full"]
        bottomleft_canvas.figure = APL_Share.SubFigList["Linearity_error_fullscreen"]
        ...
        topright_canvas.figure = APL_Share.SubFigList["Linearity_data_centre"]
        bottomright_canvas.figure = APL_Share.SubFigList["Linearity_error_centre"]
