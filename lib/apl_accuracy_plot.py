...
class Func_PlotAPLAccuracy(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        self.setWindowTitle("APL Accuracy Plot")
        ...
        topleft_canvas.figure = APL_Share.SubFigList["Accuracy_data_fullscreen"]
        bottomleft_canvas.figure = APL_Share.SubFigList["Accuracy_error_fullscreen"]
        ...
        topright_canvas.figure = APL_Share.SubFigList["Accuracy_data_centre"]
        bottomright_canvas.figure = APL_Share.SubFigList["Accuracy_error_centre"]
